...
const FollowIcon = () => (
	...
	Courses = () => (
		<Fragment>
			...
			<li>
				<Link href="/became-a-softwar-engineer-without-a-degree-in-8-months">Blog</Link>
			</li>
		</Fragment>
	),
	Resources = () => <Fragment></Fragment>,
	FooterBottom = () => <Fragment></Fragment>,
	CopyRight = () => (
		<p>
			© {new Date().getFullYear()}. <Link href="/">Pivot2Tech Bootcamp</Link> All rights reserved.
		</p>
	),
				...
				<div className="row justify-content-between text-white pt-75">
					<div className="col-lg-3 col-sm-4">
						<div className="footer-widget about-widget">
							...
							<p>
								Change careers and start your journey as a web developer with our live online courses.
								Learn the skills to freelance or a Job in tech!
							</p>
					...
					<div className="col-lg-3 col-sm-4">
						<div className="footer-widget about-widget">
							...
							<p>
								...
								disse ultrices gravida commodo
							</p>
							<h5 className="pt-5">Follow Us</h5>
							<div className="social-style-one">
								<FollowIcon />
						...
						<div className="row">
							<div className="col-sm-6">
								<div className="footer-widget contact-info-widget">
									...
									<ul>
										<li>
											<i className="fas fa-map-marker-alt" /> 55 Main Street, 2nd Block, New York
										</li>
										<li>
											<i className="far fa-envelope" />{' '}
		...
		<footer className="main-footer footer-two bg-blue-two text-white">
			<div className="container">
				<div className="logo-inner style-two pt-85 pb-35">
					...
					<div className="logo-item">
						<Link href="/about">
							<img src="assets/images/client-logos/client-logo-two5.png" alt="Client Logo" />
						</Link>
					</div>
					<div className="logo-item">
						<Link href="/about">
					...
					<div className="logo-item">
						<Link href="/about">
							<img src="assets/images/client-logos/client-logo-two4.png" alt="Client Logo" />
						</Link>
					</div>
					<div className="logo-item">
						<Link href="/about">
					...
					<div className="logo-item">
						<Link href="/about">
							<img src="assets/images/client-logos/client-logo-two6.png" alt="Client Logo" />
						</Link>
					</div>
				</div>
					...
					<div className="col-md-3 col-sm-4">
						<div className="footer-widget contact-info-widget">
							...
							<ul>
								...
								<li>
									<i className="fas fa-phone" /> <a href="callto:+0123456789">+012 (345) 67 89</a>
								</li>
								<li>
									<i className="far fa-clock" /> Sunday - Friday,
									<br /> 08 am - 05 pm
