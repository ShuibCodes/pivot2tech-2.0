				...
				{faqsLeft.map((faq, i) => (
					...
					>
						<p>
							...
							magna aliqua. Quis ipsum suspendise ultre gravida. risus commodo viverra maecenas accumsan
							lacus.{' '}
						</p>
					</WellernAccordion>
				))}
									...
									<div className="container">
										<div className="feature-three-item ">
											...
											<ul className="course-info-list">
												...
												<li>
													Build and deploy a quiz game that you can share with your friends
												</li>
											</ul>
										</div>
									</div>
								...
								<Accordion defaultActiveKey="a1">
									<div className="container">
										<div className="feature-three-item wow fadeInUp delay-0-2s">
											...
											<p>
												Learn by doing, we’ll buld multiple JavaScript projects including CRUD
												apps (Create, Read, Update, Delete). Using the relational database, SQL,
												we’ll store and exract data.
											</p>
											<ul className="course-info-list">
												<li>Master JavaScript to add dynamic behaviors to your website.</li>

												<li>DOM manipulation</li>
												<li>
													Learn to connect your database to your software with an ORM (Object
													Relational Mapping).
												</li>
											</ul>
										</div>
								...
								<Accordion defaultActiveKey="a1">
									<div className="container">
										<div className="feature-three-item wow fadeInUp delay-0-2s">
											...
											<ul className="course-info-list">
												<li>
													Using what we covered, we’ll build 2 projects for your portfolios
												</li>
												<li>
													Test your applications using TDD (Test Driven Development) with
													Jest. This is key for interviews!{' '}
												</li>
											</ul>
										</div>
									</div>
								...
								<Accordion defaultActiveKey="a1">
									<div className="container">
										<div className="feature-three-item wow fadeInUp delay-0-2s">
											...
											<ul className="course-info-list">
												<li>
													Introduction to GatsbyJS, a JavaScript framework & Static Site
													Generator
												</li>
												<li>
													Build and customize your own portfolio to host your projects using
													GatsbyJS & Netlify
												</li>
											</ul>
										</div>
										...
										<div className="form-group mb-0 form-btn-label">
											...
											<div className="custom-control custom-radio">
												<input
													...
													required=""
												/>
												<label className="custom-control-label" htmlFor="privacy-policy">
