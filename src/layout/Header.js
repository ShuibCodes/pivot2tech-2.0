						...
						<div className="header-inner d-flex align-items-center justify-content-between">
							...
							<div className="menu-btn-sidebar d-flex align-items-center">
								<div className="nav-search">
									...
									<form onSubmit={(e) => e.preventDefault()} action="#" className="hide">
				...
				<div className="container-fluid">
					<div className="top-inner">
						<div className="top-left">
							<p>
								<i className="far fa-clock" /> <b>Working Hours</b> : Manday - Friday, 08am - 05pm
							</p>
							<p>
		...
		<div className="header-top bg-light-blue text-white">
			<div className="container-fluid">
				<div className="top-inner">
					<div className="top-left">
						<p>
							<i className="far fa-clock" /> <b>Next Cohort</b> 15 March 2023
						</p>
					</div>
					<div className="top-right d-flex align-items-center">
						<div className="social-style-two">
							<h6 className="py-1">
								{' '}
								<span className="px-2">👇🏾</span> Resgister your interest below <span className="px-2">👇🏾</span>{' '}
							</h6>
						</div>
					</div>
				</div>
