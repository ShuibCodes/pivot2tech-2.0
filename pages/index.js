								...
								<div className="coach-item wow fadeInUp delay-0-6s">
									...
									<div className="coach-content">
										...
										<ul className="course-tags">
											...
											<li>
												{' '}
												<span style={{ marginRight: '8px' }}> 💻</span>Learn SEO & Low-code Web
												Design
											</li>
											<li>
												{' '}
							...
							<div className="testimonial-item">
								<div className="testimonial-content">
									...
									<p className="testimonial-p">
										...
										patient and thorough in his explaining to make sure no students fall behind, a
							...
							<div className="testimonial-item">
								<div className="testimonial-content">
									...
									<p className="testimonial-p">
										...
										tips along with getting me interview ready discussing possible questions as well
										as practice interviews to prepare me.
									</p>
									<div className="ratting">
										<i className="fas fa-star" />
										<i className="fas fa-star" />
